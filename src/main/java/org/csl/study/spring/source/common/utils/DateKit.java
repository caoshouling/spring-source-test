...
public class DateKit {
	...
	public static void main(String[] args) throws ParseException {
	    String date = DateKit.getFormatedDateStr(new Date(),"yyyyMMddHHmmssSSS");
	...
	public static Date joinDateAndHour(Date date,Double hour){
		String hourStr = "";
		if(hour == null){
			hourStr = "0";
		}else{
			hourStr = ChgDataKit.castTo(hour, Integer.class) + "";
		}
		String dateStr = transDate10(date, hourStr);
		return DateKit.parse(dateStr);
