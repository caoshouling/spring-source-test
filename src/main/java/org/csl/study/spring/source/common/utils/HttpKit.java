...
public class HttpKit {
	 ...
	 * @throws Exception
	 */
	public static String doPostForm(String url, Map<String,String> params,String encoding, int socketTimeOutParam) throws Exception {
        String resPonse = "";
	...
	public static String doPost(String url, String content,String encoding) throws Exception {
		...
		try {
			...
			logger.error("doPostSoap1_1 exception", e);
			throw e;
		}
		return retStr;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		String result = HttpKit.doPostSoap1_1("http://10.13.1.111:9988/prpall2/ssss/xxx", "", "", 10000);
