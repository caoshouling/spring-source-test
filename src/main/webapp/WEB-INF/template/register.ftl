...
<head>
  ...
  <link rel="stylesheet" href="${ctx}/static/plugin/layui/layuiadmin/style/login.css" media="all">
</head>
<body>
  ...
  <div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        ...
        <div class="layui-form-item">
          <label class="layadmin-user-login-icon layui-icon layui-icon-cellphone" for="LAY-user-login-cellphone"></label>
          <input type="text" name="mail" id="LAY-user-login-mail" lay-verify="required|email" placeholder="邮箱" class="layui-input">
        </div>
        <div class="layui-form-item">
  ...
  layui.config({
    ...
    form.on('submit(LAY-user-reg-submit)', function(obj){
      ...
      //请求接口
      admin.req({
        url: layui.setter.host +'/register' //实际使用请改成服务端真实接口
        ,data: field
        ,method:'post'
        ,done: function(res){
          layer.msg('注册成功', {
            ...
            ,time: 2000
             ...
             location.href = layui.setter.host +'/login'; //跳转到登入页
          });
        }
      });
